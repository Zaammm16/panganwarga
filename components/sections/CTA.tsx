    ...
    <section className="py-20 bg-forest relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
        ...
        <p className="text-green-100 text-lg mb-10 max-w-2xl mx-auto animate-fade-up delay-100">
          Join our network of distributors and experience the finest
          agricultural products Indonesia has to offer.
        </p>

        <div className="flex flex-col sm:flex-row justify-center gap-4 animate-fade-up delay-200">
          <a
            href="https://wa.me/+6285298591487?text=Hello, I want to discuss a partnership with Pangan Warga."
            target="_blank"
            rel="noopener noreferrer"
            className="bg-gold text-forest px-8 py-4 rounded-full font-bold hover:bg-white transition-colors shadow-lg inline-block"
          >
            Chat on WhatsApp
          </a>
          <Link
