  ...
  return (
    <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        {/* Gambar Latar Belakang Baru (Sulawesi Barat) */}
        <img 
          src="/images/hero.png" 
          alt="Komoditas Unggulan Sulawesi Barat - Kakao, Kopi, dan Kelapa" 
          className="w-full h-full object-cover"
        />
        {/* Gradient Overlay: Gelap di atas, transparan di tengah, menyatu dengan warna cream di bawah */}
        <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/30 to-cream"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 text-center text-white mt-16">
        ...
        {/* Headline Besar (Bisa disesuaikan jika ingin lebih menonjolkan Sulbar) */}
        <h1 className="animate-fade-up delay-100 text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-tight mb-6 drop-shadow-lg">
          From the Earth of <br/> West Sulawesi to the World
        </h1>
